...
Figure \ref{fig:accuracy-f1} shows that high accuracy and high F1 are not the same thing.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.68\textwidth]{outputs/final_report/figures/accuracy_vs_f1.png}
\caption{Next-event accuracy vs anomaly F1. High prediction accuracy does not always mean good anomaly detection.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.54\textwidth]{outputs/final_report/figures/gaia_status_ablation.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.70\textwidth]{outputs/final_report/figures/sequence_length_sweep.png}
